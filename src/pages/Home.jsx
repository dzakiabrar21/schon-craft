    ...
    <div className="bg-[#FEF9E1] font-sans text-[#6D2323] overflow-x-hidden relative">
      ...
      >
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center space-y-8">
          <h1 className="text-5xl md:text-7xl font-serif font-bold leading-tight text-[#FEF9E1] tracking-tight drop-shadow-lg">
            ONE STITCH AT A TIME
          </h1>
          <p className="text-xl md:text-2xl text-[#FEF9E1] font-sans font-normal leading-relaxed max-w-2xl mx-auto drop-shadow-md">
            we carefully craft each piece by hand, embracing simplicity, warmth, and timeless craftsmanship.
          </p>
          <div className="pt-8">
            <button 
              onClick={() => {
                const element = document.getElementById('ourCollection-section');
                element?.scrollIntoView({ behavior: 'smooth' });
              }}
              className="bg-white text-[#A31D1D] font-sans font-bold text-lg py-4 px-12 rounded-full shadow-xl hover:bg-[#E5D0AC] hover:text-[#6D2323] hover:scale-105 transition duration-300"
            >
              Explore More
            </button>
          </div>
      ...
      <section className="bg-[#FEF9E1] py-24 px-6">
        <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {/* Kartu 1 */}
                <div className="bg-white rounded-xl shadow-md hover:shadow-xl transition duration-300 transform hover:-translate-y-1 overflow-hidden border border-[#E5D0AC]/50">
                    <div className="h-64 bg-gray-100 flex items-center justify-center">
                        <img src="/images/hki_dschon.png" alt="HKI Certificate" className="h-full object-contain p-4" />
                    </div>
                ...
                <div className="bg-white rounded-xl shadow-md hover:shadow-xl transition duration-300 transform hover:-translate-y-1 overflow-hidden border border-[#E5D0AC]/50">
                    <div className="h-64 bg-gray-100 flex items-center justify-center">
                        <img src="/images/hki_milioiki.png" alt="HKI Certificate" className="h-full object-contain p-4" />
                    </div>
                    <div className="p-6 space-y-2">
                        <h4 className="font-serif text-2xl font-semibold text-[#6D2323]">HKI Merek Certificate</h4>
                ...
                <div className="bg-white rounded-xl shadow-md hover:shadow-xl transition duration-300 transform hover:-translate-y-1 overflow-hidden border border-[#E5D0AC]/50">
                    <div className="h-64 bg-gray-100 flex items-center justify-center">
                        <img src="/images/export_training.png" alt="Export Training" className="h-full object-contain p-4" />
                    </div>
                    <div className="p-6 space-y-2">
      ...
      <section id="ourCollection-section" className="bg-white py-24 px-6">
        <div className="max-w-7xl mx-auto text-center space-y-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
                {filteredProducts.map((product) => {
                    // Kalkulasi Single Price menggunakan basePrice IDR
                    ...
                    // Ambil gambar utama dari varian pertama (Fallback ke product.image jika varian kosong)
                    const mainImage = product.variants?.[0]?.images[0] || product.image || '/images/placeholder.png';
                        ...
                        >
                            ...
                            <div className="flex flex-col flex-grow p-4">
                                ...
                                <div className="flex justify-between items-start gap-2 mb-2">
                                    <h4 className="font-serif text-xl md:text-2xl font-bold text-[#6D2323] leading-tight">
                                        {product.name}
                                    </h4>
                                    <p className="text-[10px] md:text-xs text-[#6D2323]/60 font-sans mt-2 italic uppercase tracking-wide text-right whitespace-nowrap flex-shrink-0">
